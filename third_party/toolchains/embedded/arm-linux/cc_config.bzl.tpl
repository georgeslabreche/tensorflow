                ...
                flag_set(
                    ...
                    flag_groups = [
                        flag_group(
                            flags = [
                                "-isystem",
                                "%{AARCH64_COMPILER_PATH}%/lib/gcc/aarch64-linux-gnu/6.5.0/include",
                                "-isystem",
                                "%{AARCH64_COMPILER_PATH}%/lib/gcc/aarch64-linux-gnu/6.5.0/include-fixed",
                                "-isystem",
                                "%{AARCH64_COMPILER_PATH}%/aarch64-linux-gnu/include/c++/6.5.0/",
                                "-isystem",
                ...
                flag_set(
                    ...
                    flag_groups = [
                        flag_group(
                            flags = [
                                "-isystem",
                                "%{ARMHF_COMPILER_PATH}%/lib/gcc/arm-linux-gnueabihf/6.5.0/include",
                                "-isystem",
                                "%{ARMHF_COMPILER_PATH}%/lib/gcc/arm-linux-gnueabihf/6.5.0/include-fixed",
                                "-isystem",
                                "%{ARMHF_COMPILER_PATH}%/arm-linux-gnueabihf/include/c++/6.5.0/",
                                "-isystem",
