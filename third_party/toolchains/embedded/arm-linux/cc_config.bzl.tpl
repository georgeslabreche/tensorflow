                ...
                flag_set(
                    ...
                    flag_groups = [
                        flag_group(
                            flags = [
                                "-isystem",
                                "%{AARCH64_COMPILER_PATH}%/lib/gcc/aarch64-linux-gnu/7.3.1/include",
                                "-isystem",
                                "%{AARCH64_COMPILER_PATH}%/lib/gcc/aarch64-linux-gnu/7.3.1/include-fixed",
                                "-isystem",
                                "%{AARCH64_COMPILER_PATH}%/aarch64-linux-gnu/include/c++/7.3.1/",
                                "-isystem",
                ...
                flag_set(
                    ...
                    flag_groups = [
                        flag_group(
                            flags = [
                                "-isystem",
                                "%{ARMHF_COMPILER_PATH}%/lib/gcc/arm-linux-gnueabihf/7.3.1/include",
                                "-isystem",
                                "%{ARMHF_COMPILER_PATH}%/lib/gcc/arm-linux-gnueabihf/7.3.1/include-fixed",
                                "-isystem",
                                "%{ARMHF_COMPILER_PATH}%/arm-linux-gnueabihf/include/c++/7.3.1/",
                                "-isystem",
